...
<div class="container">
    ...
    <form action="{{ route('patients.update', $patient->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nom" class="form-control" value="{{ old('nom', $patient->nom) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="ville" class="form-control" value="{{ old('ville', $patient->ville) }}">
        </div>

        <div class="mb-3">
            <label for="tel" class="form-label">Téléphone</label>
            <input type="text" name="tel" class="form-control" value="{{ old('tel', $patient->tel) }}">
        </div>

        <div class="mb-3">
            <label class="form-label d-block">Sexe</label>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sexe" id="sexeM" value="M" {{ old('sexe', $patient->sexe) == 'M' ? 'checked' : '' }} >
                <label class="form-check-label" for="sexeM">Homme</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sexe" id="sexeF" value="F" {{ old('sexe', $patient->sexe) == 'F' ? 'checked' : '' }} >
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.1" name="taille" class="form-control" value="{{ old('taille', $patient->taille) }}" >
        </div>

        <div class="mb-3">
            <label for="poids" class="form-label">Poids (kg)</label>
            <input type="number" step="0.1" name="poids" class="form-control" value="{{ old('poids', $patient->poids) }}" >
        </div>

        <div class="mb-3">
            <label for="groupe_sangin" class="form-label">Groupe Sanguin</label>
            <input type="text" name="groupe_sangin" class="form-control" value="{{ old('groupe_sangin', $patient->groupe_sangin) }}" >
        </div>

        <div class="mb-3">
            <label class="form-label d-block">Assuré</label>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="assure" id="assureOui" value="1" {{ old('assure', $patient->assure) == 1 ? 'checked' : '' }} >
                <label class="form-check-label" for="assureOui">Oui</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="assure" id="assureNon" value="0" {{ old('assure', $patient->assure) == 0 ? 'checked' : '' }} >
