...
<div class="container">
    ...
    <form action="{{ route('patients.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="groupe_sangin" class="form-control" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
                ...
                <input class="form-check-input" type="radio" name="assure" value="1" required>
                <label class="form-check-label">Oui</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="assure" value="0" required>
